    ...
    <section className="section-pad page-top">
      ...
      <div className="project-list">
        <Link className="project-list-card featured" href="/projects/rfid-music-player">
          ...
          <div>
            <span className="badge">Aktiv · Starterprojekt</span>
        ...
        <div className="project-list-card muted">
          <div className="project-number">002</div>
          <div><span className="badge subtle">Als Nächstes</span><h2>Environmental Node</h2><p>Sensorik, I²C, Sampling und Telemetrie als zweites Projekt mit wiederverwendetem Grundlagenwissen aus Projekt 001.</p></div>
          <div className="project-side"><strong>—</strong><span>in Planung</span></div>
        </div>
      </div>
    </section>
  );
